...
let btn = document.querySelectorAll(".image");
...
function userWin(user , code){
    uScore++ ;
    document.querySelector("h1").innerText = "You won ..  "+user+" beats "+code;
...
function codeWin(user , code){
    cScore++ ;
    document.querySelector("h1").innerText = "You lost ..  "+code+" beats "+user;
